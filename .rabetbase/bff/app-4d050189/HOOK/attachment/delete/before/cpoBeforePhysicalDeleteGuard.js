 ...
 * [接口路径] POST /api/app-4d050189/ab17964f0efd46f78cecb4969140f257/delete
 * [触发节点] before
 * [平台配置] https://app.lovrabet.com/app/app-4d050189/data/dataset/1013764#api-list
 *
...
export default async function cpoBeforePhysicalDeleteGuard(params, context) {
  return context.client.bff.execute({
    ...
    params: { resource: "attachment", values: params },
  });
}
