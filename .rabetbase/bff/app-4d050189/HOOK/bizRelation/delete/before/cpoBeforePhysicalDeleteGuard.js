 ...
 * [接口路径] POST /api/app-4d050189/1a4139b6d59a493ea89111d936e27238/delete
 * [触发节点] before
 * [平台配置] https://app.lovrabet.com/app/app-4d050189/data/dataset/1013838#api-list
 *
...
export default async function cpoBeforePhysicalDeleteGuard(params, context) {
  return context.client.bff.execute({
    ...
    params: { resource: "bizRelation", values: params },
  });
}
