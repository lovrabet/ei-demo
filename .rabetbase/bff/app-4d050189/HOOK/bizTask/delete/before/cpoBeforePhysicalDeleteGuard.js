 ...
 * [接口路径] POST /api/app-4d050189/da9cddc0fd244545b94ae7cddfde21ea/delete
 * [触发节点] before
 * [平台配置] https://app.lovrabet.com/app/app-4d050189/data/dataset/1013774#api-list
 *
...
export default async function cpoBeforePhysicalDeleteGuard(params, context) {
  return context.client.bff.execute({
    ...
    params: { resource: "bizTask", values: params },
  });
}
