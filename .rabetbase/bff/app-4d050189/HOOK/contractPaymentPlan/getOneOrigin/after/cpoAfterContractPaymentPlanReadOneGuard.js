 ...
 *
 * [脚本描述] 合同付款计划单条读取继承合同权限
 * [接口路径] POST /api/app-4d050189/08e17d8ba3a24e938fef89816c8f4ccb/getOneOrigin
 * [触发节点] after
 *
 ...
 */
export default async function cpoAfterContractPaymentPlanReadOneGuard(
  params,
  context,
) {
  return context.client.bff.execute({
    scriptName: "cpoContractPaymentPlanReadOneGuard",
