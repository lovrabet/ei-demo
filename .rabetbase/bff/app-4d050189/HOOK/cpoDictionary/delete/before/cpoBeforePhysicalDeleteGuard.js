 ...
 * [接口路径] POST /api/app-4d050189/ecebe4f9726b46ccb19aaca00aa93dd0/delete
 * [触发节点] before
 * [平台配置] https://app.lovrabet.com/app/app-4d050189/data/dataset/1014323#api-list
 *
...
export default async function cpoBeforePhysicalDeleteGuard(params, context) {
  return context.client.bff.execute({
    ...
    params: { resource: "dictionary", values: params },
  });
}
