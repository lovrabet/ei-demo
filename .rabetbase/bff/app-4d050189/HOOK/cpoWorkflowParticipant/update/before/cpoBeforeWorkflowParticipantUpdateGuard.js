 ...
 *
 * [脚本描述] 禁止标准接口修改工作流参与者
 * [接口路径] POST /api/app-4d050189/464ca3622eab43a3a4b4b4f23af26a8c/update
 * [触发节点] before
 *
 ...
 */
export default async function cpoBeforeWorkflowParticipantUpdateGuard(params, context) {
  return context.client.bff.execute({
    scriptName: "cpoDirectWriteGuard",
    params: { resource: "cpoWorkflowParticipant", operation: "update" },
  });
}
