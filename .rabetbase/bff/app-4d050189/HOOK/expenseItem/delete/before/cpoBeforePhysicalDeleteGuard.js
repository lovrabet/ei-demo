 ...
 * [接口路径] POST /api/app-4d050189/d99c32ef07b749948cc24fd391f8fd2c/delete
 * [触发节点] before
 * [平台配置] https://app.lovrabet.com/app/app-4d050189/data/dataset/1013773#api-list
 *
...
export default async function cpoBeforePhysicalDeleteGuard(params, context) {
  return context.client.bff.execute({
    ...
    params: { resource: "expenseItem", values: params },
  });
}
